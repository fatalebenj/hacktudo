...
<section class="box" id="painel-box">
    ...
    <form action="/action/criar_mural.php" style="grid-column: 2; grid-row: 1;">
        <button type="submit" class="btn btn-primary">+ Novo Mural</button>
    </form>
    <form action="/actions/logout.php" method="POST" style="grid-column: 3; grid-row: 1;">
        <?= Auth::csrfField(); ?>
